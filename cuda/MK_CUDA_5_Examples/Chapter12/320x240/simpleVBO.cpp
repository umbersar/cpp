...
#define MESH_WIDTH 320
#endif
#ifndef MESH_HEIGHT
//#define MESH_HEIGHT 480
#define MESH_HEIGHT 240
#endif
// constants
...
// vbo variables
mappedBuffer_t vertexVBO = {(GLuint)NULL, sizeof(float4), NULL};
mappedBuffer_t colorPBO =  {(GLuint)NULL, sizeof(uchar4), NULL};
